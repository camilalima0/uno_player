...
#define HAVE_STRUCT_TIME_TM_GMTOFF 1
...
/* #undef PROG_CPP */
/* #undef PROG_PL */
#define PTHREAD_CPUCLOCKS 1
#define QSORT_R_GNU 1
...
#define HAVE_Z_CRC_T 1
#define HAVE_SIZEOF_OFF_T TRUE
...
/* #undef size_t */
/* #undef vfork */
/* #undef HAVE_TCMALLOC_EXTENSION_C_H */
/* #undef O_STATIC_EXTENSIONS */
#define HAVE___BUILTIN_MUL_OVERFLOW 1
#define O_GMP 1
/* #undef O_BF */
#define O_VALIDATE_API 1

#define HAVE_PTHREAD_GETCPUCLOCKID
#define HAVE_F_SETLKW
